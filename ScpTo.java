...
public class ScpTo{
  public static void uploadfile(String[] arg){ //takes an array of 
    if(arg.length!=2){
    ...
    try{
      ...
      //strings parsed from argument lfile 

      JSch jsch=new JSch();
      Session session=jsch.getSession(user, host, 22);
      //session created from JSch (session factory as it contains getSession)
